  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        window.location.href = '/AMMON/success';
      } else {
        ...
        <div className="flex flex-wrap -mx-3 mb-4 border border-dark rounded-xl p-3">
          <div className="w-full px-3">
            <label
              ...
              htmlFor="previous_position"
            >
              Which job salaray do you prefer to take?{' '}
              <span className="text-red-600">*</span>
            </label>
            <select
              id="previous_position"
            ...
            >
              <option className="text-white bg-black" value="">
                Choose your prefered salary
              </option>

              <option className="text-light bg-dark p-4">
                {formData.previous_position}
              </option>
              <option className="text-light bg-dark p-4">
                {formData.position}
              </option>
