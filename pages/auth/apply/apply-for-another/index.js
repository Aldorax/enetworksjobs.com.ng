...
export default function HireForm() {
  return (
    <div className="flex flex-col items-start justify-center w-screen max-w-screen p-6 md:p-12">
      ...
      <Link href="/auth/apply/apply-for-another/executive-business-managerial-positions">
        <Button
          auto
          shadow
          size="small"
      ...
      <br />
      <Link href="/auth/apply/apply-for-another/ngo-community-portfolio-desk-offices">
        <Button
          auto
          shadow
          size="small"
      ...
      <br />
      <Link href="/auth/apply/apply-for-another/local-govt-buisness-office">
        <Button
          auto
          shadow
          size="small"
      ...
      <br />
      <Link href="/auth/apply/apply-for-another/local-govt-ngo-desk-office">
        <Button
          auto
          shadow
          size="small"
